  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header">
	  ...
	  <?php endif;?>
	  	...
	  	<div style="position: absolute; top: 6px; left: 22px; width: 172px; height: 21px;cursor: pointer;" onclick="location.href='http://www.vibelifestylenetwork.com/'"></div>
	  	<div style="position: absolute; top: 6px; left: 218px; width: 250px; height: 21px;cursor: pointer;" onclick="location.href='http://www.vibe.com/altima-experience'"></div>
	  	<div style="position: absolute; top: 6px; left: 480px; width: 145px; height: 21px; cursor: pointer;" onclick="location.href='/in-the-mag'"></div>
	  <div style="position: absolute; top: 6px; left: 645px; width: 200px; height: 21px; cursor: pointer;" onclick="location.href='http://www.vibe.com/contests/full-sail-ipod-giveaway'"></div>
	  </div>
