...
<?php if ($tree || $has_links): ?>
  <div id="book-navigation-<?php print $book_id; ?>" class="book-navigation">
    ...
    <div class="page-links clear-block">
      <?php if ($prev_url) : ?>
        <div id="book_nav_prev"><a href="<?php print $prev_url; ?>" class="page-previous" title="<?php print t('Go to previous page'); ?>"><div class="book_nav_text">PREVIOUS</div> <div class="book_nav_title"><?php print $prev_title; ?></div></a></div>
      <?php endif; ?>
      <?php if ($next_url) : ?>
        <div id="book_nav_next"><a href="<?php print $next_url; ?>" class="page-next" title="<?php print t('Go to next page'); ?>"><div class="book_nav_text">NEXT</div><div class="book_nav_title"><?php print $next_title; ?></div></a></div>
      <?php endif; ?>
    </div>
    <?php endif; ?>
