...
<?php $thumbnail = $fields["field_story_thumb_fid_1"]?>
...
<li class="latest_on_vibe_thumbnail_horizontal" style="position: relative; background-color: transparent; list-style: none; width: 172px; height: 137px;">
	...
	<div style="position: absolute; top: 90px; width: 150px; height: 37px; left: 5px; z-index: 15; color: #ffffff; overflow: hidden;"><a style="color: #ffffff; text-decoration: none;" href="<?php print $fields["link"]->raw?>"><?php print $fields["title"]->content?></a></div>
	
	<div style="position: absolute; top: 0px; left: 0px; width: 162px; height: 127px; z-index: 10;"><?php print $thumbnail->content;?></div>
