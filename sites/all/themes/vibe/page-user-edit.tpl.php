...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header">
	  ...
	  <?php print theme_render_template("sites/all/themes/vibe/block-ads.tpl.php",array("size"=>"728x90","tile"=>"1")); ?>      
      <?/*<script type="text/javascript">
      	if(typeof(hide_728x90_1) == "undefined" || hide_728x90_1 != true) {
      		if (typeof ord=='undefined') {ord=Math.floor(Math.random()*10000000000000000);}
      		document.write('<div id="728x90_1" class="ad728x90 ad">');
    		document.write('<scr' + 'ipt src="http://ad.doubleclick.net/adj/vibe.blackrock/profile;sect=profile;subs=profile;cmts=off;subss=;page=6666cd76f96956469e7be39d750cc7d9;tile=1;dcopt=ist;sz=728x90;ord=' + ord + '?" type="text/javascript" language="javascript"></scr' + 'ipt>');
    		document.write('</div>')
    	}
      </script>*/?>
      <!-- /#header -->
