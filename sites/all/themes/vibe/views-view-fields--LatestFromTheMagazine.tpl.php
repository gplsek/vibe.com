...
<div class="latest_on_vibe_post">
	<div class="latest_on_vibe_thumbnail">
		<?php 
			if (!empty($fields["field_img_src_fid"]->content)) {
				$thumbnail = $fields["field_img_src_fid"];
			} else {
				$thumbnail =$fields["field_story_thumb_fid"]; 
			}
		?>
	...
	<div class="latest_on_vibe_excerpt">
		<div class="latest_on_vibe_title">
			...
			<span class="latest_on_vibe_title_inner">
				<span class="content_title"><a href="<?php print $link?>"><?php print preg_replace("/&amp;.*?;/","",$title->content);?></a></span>
			</span>
		</div>
